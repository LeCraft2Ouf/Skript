...
public class EvtBlock extends SkriptEvent {
    ...
    public boolean check(final Event e) {
        ...
        if (e instanceof BlockPlaceEvent) {
            ...
            // Obtenez l'objet tenu par le joueur
            ItemStack itemInHand = blockPlaceEvent.getItemInHand();
            item = new ItemType(itemInHand);
            blockData = blockPlaceEvent.getBlock().getBlockData();
            Variables.setVariable("ITEM_" + player.getName(), item, null, false);
